...
//    $('#grid-container div').attr('class', 'grid-cell');
    ...
    $.ajax({
        type: 'GET',
        url: 'http://beta.taihuoniao.com/api/gateway/bonus',
        //url: 'data.html',
        dataType: "json",
...
function gameover() {
    if (find == true) {
        var url = 'http://beta.taihuoniao.com/api/gateway/game_result?version=' + version + '&uid=' + uid + '&bonus=code' + ':1';
    } else {
        var url = 'http://beta.taihuoniao.com/api/gateway/game_result?version=' + version + '&uid=' + uid + '&bonus=code' + ':0';
    }
...
function getCode() {
    ...
    $.ajax({
        type: 'GET',
        url: 'http://beta.taihuoniao.com/api/auth/verify_code?version=' + version + '&mobile=' + mobile,
        dataType: "json",
...
function register() {
    ...
    $.ajax({
        type: 'GET',
        url: 'http://beta.taihuoniao.com/api/auth/register?version=' + version + '&mobile=' + mobile + '&password=' + password + '&verify_code=' + verify_code,
        //url: 'data.html',
        dataType: "json",
        success: function (result) {
...
function login(mobile, password) {
    ...
    $.ajax({
        type: 'GET',
        url: 'http://beta.taihuoniao.com/api/auth/login?version=' + version + '&mobile=' + mobile + '&password=' + password,
        dataType: "json",
        success: function (result) {
            var success = result.success;
            if (success == true) {
...
function got_bonus() {
    ...
    $.ajax({
        type: 'GET',
        url: 'http://beta.taihuoniao.com/api/gateway/got_bonus?version=' + version + '&uid=' + uid + '&bonus=' + bonus,
        //url: 'data.html',
        dataType: "json",
        success: function (result) {
...
function share() {
    if (typeof WeixinJSBridge == "undefined") {
        ...
        WeixinJSBridge.invoke("shareTimeline", {
            ...
            "desc" :"",
            "link": "http://beta.taihuoniao.com/games/playegg/home.html",
            "img_url": "http://beta.taihuoniao.com/games/playegg/images/share.jpg",
            "img_width": "640",
            "img_height": "640"
        });
